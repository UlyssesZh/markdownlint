...
class TestCli < Minitest::Test
  ...
  def test_ignore_front_matter
    ...
    files = %w{jekyll_post.md jekyll_post_2.md jekyll_post_3.md no_title.md}
    files = files.map { |f| File.join(path, f) }.join(' ')
    ...
    expected = <<~OUTPUT
      ...
      #{path}/no_title.md:5: MD002 First header should be a top level header
